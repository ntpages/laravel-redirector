...
namespace Ntpages\LaravelRedirector\Commands;

use Ntpages\LaravelRedirector\Events\DetectedBrokenRedirect;
use Ntpages\LaravelRedirector\Models\Redirect;
use Illuminate\Console\Command;

class CheckHealthiness extends Command
{
    /**
    ...
    {
        Redirect::all()->each(function (Redirect $redirect) {
